...
public class ExamController {
    ...
    @GetMapping
    public List<Exam> getAllExams(@RequestHeader(value = "X-User-Role", required = false) String role,
            @RequestHeader(value = "X-User-Class", required = false) String className) {
